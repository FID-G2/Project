...
plot_limpio <- ggplot(dataset_limpio, aes(x = Rama.de.enseñanza, y = Número.de.estudiantes, fill = Sexo)) +
...
plot_ruido_20 <- ggplot(dataset_ruido_20, aes(x = Rama.de.enseñanza, y = Número.de.estudiantes, fill = Sexo)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Distribución de sexo dentro de una rama del conocimiento",
       x = "Rama del conocimiento",
       y = "Cantidad de estudiantes") +
