...
dataset_limpio <- read.csv("../data/CleanData/dataset_integrado.csv")
dataset_ruido_20 <- read.csv("../2. Add-noise/dataset_ruido.csv")
```

Queremos construir una relación entre el sexo de los estudiantes y la rama de enseñanza a la que acceden, en función de la comunidad autónoma a la que pertenecen.
...
agg_dataset_limpio <- dataset_limpio %>%
  group_by(Comunidad.Autónoma, Sexo, Rama.de.enseñanza) %>%
...
subseleccion_cas <- c("Andalucía", "Cataluña", "Extremadura", "Madrid", "Valencia")

dataset_limpio_subseleccion_cas <- agg_dataset_limpio[agg_dataset_limpio$Comunidad.Autónoma %in% subseleccion_cas, ]

dataset_ruido_20_sin_na_subseleccion_cas <- agg_dataset_ruido_20_sin_na[agg_dataset_ruido_20_sin_na$Comunidad.Autónoma %in% subseleccion_cas, ]

dataset_ruido_20_media_numero_subseleccion_cas <- agg_dataset_ruido_20_media_numero[agg_dataset_ruido_20_media_numero$Comunidad.Autónoma %in% subseleccion_cas, ]

plot_limpio_cas <- ggplot(dataset_limpio_subseleccion_cas, aes(x = Rama.de.enseñanza, y = Número.de.estudiantes, fill = Comunidad.Autónoma)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Distribución de comunidad autónoma dentro de una rama del conocimiento",
       x = "Rama del conocimiento",
       y = "Cantidad de estudiantes",
       fill = "Comunidad autónoma") +
  scale_fill_manual(values = c("Andalucía" = "green", "Cataluña" = "purple", "Extremadura" = "brown", "Madrid" = "blue", "Valencia" = "orange")) +
  theme_minimal()

plot_ruido_20_sin_na_cas <- ggplot(dataset_ruido_20_sin_na_subseleccion_cas, aes(x = Rama.de.enseñanza, y = Número.de.estudiantes, fill = Comunidad.Autónoma)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Distribución de comunidad autónoma dentro de una rama del conocimiento",
       x = "Rama del conocimiento",
       y = "Cantidad de estudiantes",
...
plot_ruido_20_media_numero_cas <- ggplot(dataset_ruido_20_media_numero_subseleccion_cas, aes(x = Rama.de.enseñanza, y = Número.de.estudiantes, fill = Comunidad.Autónoma)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Distribución de comunidad autónoma dentro de una rama del conocimiento",
       x = "Rama del conocimiento",
       y = "Cantidad de estudiantes",
...
print(plot_limpio_cas)
print(plot_ruido_20_sin_na_cas)
print(plot_ruido_20_media_numero_cas)
```
...
1.- Selección de atributos: Eliminar columnas innecesarias. Es decir, todas menos comunidad autónoma, sexo, rama de enseñanza y número de estudiantes
...
```{r}
seleccion_dataset_limpio <- dataset_limpio[, c("Comunidad.Autónoma", "Sexo", "Rama.de.enseñanza", "Número.de.estudiantes")]

seleccion_dataset_ruido_20 <- dataset_ruido_20[, c("Comunidad.Autónoma", "Sexo", "Rama.de.enseñanza", "Número.de.estudiantes")]
```
...
seleccion_dataset_limpio <- aggregate(Número.de.estudiantes ~ Comunidad.Autónoma + Sexo + Rama.de.enseñanza, data = seleccion_dataset_limpio, sum)

filtro_seleccion_dataset_ruido_20 <- aggregate(Número.de.estudiantes ~ Comunidad.Autónoma + Sexo + Rama.de.enseñanza, data = filtro_seleccion_dataset_ruido_20, sum)

modificado_seleccion_dataset_ruido_20 <- aggregate(Número.de.estudiantes ~ Comunidad.Autónoma + Sexo + Rama.de.enseñanza, data = modificado_seleccion_dataset_ruido_20, sum)
```
...
dataset_limpio_subseleccion_cas <- vis_seleccion_dataset_limpio[vis_seleccion_dataset_limpio$Comunidad.Autónoma %in% subseleccion_cas, ]

dataset_ruido_20_sin_na_subseleccion_cas <- vis_filtro_seleccion_dataset_ruido_20[vis_filtro_seleccion_dataset_ruido_20$Comunidad.Autónoma %in% subseleccion_cas, ]

dataset_ruido_20_media_numero_subseleccion_cas <- vis_modificado_seleccion_dataset_ruido_20[vis_modificado_seleccion_dataset_ruido_20$Comunidad.Autónoma %in% subseleccion_cas, ]
