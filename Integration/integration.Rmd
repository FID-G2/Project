...
csv_notas_medias <- "data/dataset_notas_medias.csv"
csv_zona_nacionalidad_ambito_estudio <- "data/dataset_zona_nacionalidad_ambito_estudio.csv"
...
extraction_path <- "data/dataset_integrado.csv"
