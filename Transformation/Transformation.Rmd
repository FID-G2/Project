...
En esta sección, se lleva a cabo el proceso de normalización de los datos con el objetivo de asegurar que todas las variables estén en una escala uniforme. La normalización es esencial, especialmente cuando las características tienen escalas diferentes, ya que ayuda a evitar que ciertas variables dominen sobre otras en modelos sensibles a la escala.

Seleccionar las columnas numericas sobre las que aplicar la normalización.
