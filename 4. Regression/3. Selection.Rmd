...
reduce_dimensionality <- function(data, patterns, new_names) {
  ...
  for (i in seq_along(patterns)) {
    ...
    # Normalizar los valores de PCA entre 0 y 1
    pca_columns <- rescale(pca_columns)
...
Almacenar en un dataframe todos los componentes de PCA generados, para, en el archivo Model.Rmd, poder determinar automáticamente transformación entre las variables categóricas intruducidas por el usuario, como Comunidad Autónoma, y sus PCAs asociadas.
