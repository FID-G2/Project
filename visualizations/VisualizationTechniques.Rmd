...
for (campo in campos_distintos) {
  histograma <- crear_histograma(datos, campo, Campo)
  print(histograma)
}
```
...
campos_distintos <- unique(datos$Nivel)

for (campo in campos_distintos) {
  histograma <- crear_histograma(datos, campo, Nivel)
  print(histograma)
}
```
...
for (campo in campos_distintos) {
  diagrama_dispersion <- crear_diagrama_dispersion(datos, campo, Campo)
...
# Iterar sobre cada campo y crea un diagrama de dispersión
for (campo in campos_distintos) {
  diagrama_dispersion <- crear_diagrama_dispersion(datos, campo, Nivel)
  print(diagrama_dispersion)
}
```
...
for (campo in campos_distintos) {
  diagrama_violin <- crear_diagrama_violin(datos, campo, Campo)
...
# Iterar sobre cada campo y crea un diagrama de violín
for (campo in campos_distintos) {
  diagrama_violin <- crear_diagrama_violin(datos, campo, Nivel)
  print(diagrama_violin)
}
```
